        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card mt-5 p-4">
                    <h1 align="center" style="color: #005f73;">STUDENT LOGIN</h1>
                    <form method="post" enctype="multipart/form-data" class="mt-4">
                        <div class="mb-3">
                            <input type="text" class="form-control" placeholder="Enter User Name" name="use" required>
                        </div>
                        <div class="mb-3">
...
<?php
    ...
    if (isset($_POST["sub"])) {
        $use = $_POST["use"];
        $pass = $_POST["pass"];
        $q = "select * from students_info where username='$use' and password='$pass' and status='approve'";
        ...
        if ($row = mysqli_fetch_row($sq)) {
            ...
            print("<script> alert('Login successful'); document.location='student_das.php';</script>");
        } else {
            print("<script> alert('Enter a valid password');</script>");
        }
    }
}
?>