        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card mt-5 p-4">
                    <h1 align="center" style="color: #005f73;">FACULTY LOGIN</h1>
...
if ($con) {
    if (isset($_POST["sub"])) {
        $use = $_POST["use"];
        $pass = $_POST["pass"];
        $q = "select * from faculty_info where username='$use' and password='$pass'";
        ...
        if ($row = mysqli_fetch_row($sq)) {
            ...
            print("<script> alert('Login successful'); document.location='faculty_das.php';</script>");
        } else {
